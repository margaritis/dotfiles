...
if [ "$TERM_PROGRAM" == "iTerm.app" ]; then
    ...
    if [ -d "$VIRTUAL_ENV/lib/python3.7/site-packages/powerline" ]; then
        powerline-daemon -q
        POWERLINE_BASH_CONTINUATION=1
        POWERLINE_BASH_SELECT=1
        source $HOME/.virtualenvs/venv/lib/python3.7/site-packages/powerline/bindings/bash/powerline.sh
    fi
fi
